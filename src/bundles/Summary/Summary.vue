        ...
        <div id="container" class="block-container">
            ...
            <div class="row-2" id="row-block-2">
                <div id="item-row-1" class="about">
                    ...
                    Но как личность я люблю смотреть кинематографии разных самых стран, слушать музыку, играть в шахматы, а также читать книги. Но самое любимое мое хобби — это музыка.</span>
                        <span>Музыкой я начал занимать ещё в детстве, но был большой перерыв и теперь снова встал на этот путь. На втором месте программирование: тут я разрабатываю свои pet-проекты и улучшая навыки. 
                    Хотя, по сути, я в равной степени уделяю время двум направления.</span>
